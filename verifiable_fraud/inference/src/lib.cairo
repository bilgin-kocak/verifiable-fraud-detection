...
use node_output_weight::get_node_output_weight;
use node_output_bias::get_node_output_bias;


fn main(node_onnx_gemm_0: Tensor<FP16x16>) -> Tensor<FP16x16> {
let node__layer1_gemm_output_0 = NNTrait::gemm(node_onnx_gemm_0, get_node_layer1_weight(), Option::Some(get_node_layer1_bias()), Option::Some(FP16x16 { mag: 65536, sign: false }), Option::Some(FP16x16 { mag: 65536, sign: false }), false, true);
...
let node__output_gemm_output_0 = NNTrait::gemm(node__relu_1_relu_output_0, get_node_output_weight(), Option::Some(get_node_output_bias()), Option::Some(FP16x16 { mag: 65536, sign: false }), Option::Some(FP16x16 { mag: 65536, sign: false }), false, true);
let node_12 = NNTrait::sigmoid(@node__output_gemm_output_0);
